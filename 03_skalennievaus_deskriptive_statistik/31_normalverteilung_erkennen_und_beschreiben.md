# Normalverteilte Daten erkennen und beschreiben
...
Wir sehen, dass die Variable `q02` als *nicht normalverteilt* (p =  .6%) angesehen werden kann. Die Variable `q03` wird hingegen als *normalverteilt* erkannt (p = 24.8%). 
